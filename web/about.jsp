...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="about.jsp"><i class="fa fa-sitemap"></i> </i> 关于</a>
                </li>
            </ul>
    ...
    <div id="page-wrapper">
        ...
        <div id="page-inner" >
                ...
                <img src="jsp/assets/img/sf1.jpg" alt="" style="width: 636px; height: 431px;display: block;margin: 0 auto; " >

            <div>
                <p style="line-height: 50pt;text-indent: 2em;font-size: 24px;" >于2018年9月开始设计。</p>
            </div>
            </div>
    </div>
</div>
