...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="active-menu" href="announcements.jsp">发布公告</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" >
        ...
        <form action="${pageContext.request.contextPath }/addAnnouncement.do" method="post">
            <div id="page-inner">
                ...
                <div class="form-group">
                    <label>公告内容</label>
                    <textarea class="form-control" rows="10" placeholder="请输入公告内容" name="content" id="content"></textarea>
                </div>
                <br>
                ...
                <br>
                <div class="checkbox">
                    <button type="submit" class="btn btn-primary" id="sub">发布公告</button>
                </div>
                <%
                    String fk = (String)request.getAttribute("anno");
                    if(fk!=null){
                %>
