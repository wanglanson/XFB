...
<div id="wrapper">
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="del_device.jsp">删除设备</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper">
        ...
        <div id="container">
            <form role="form" action="${pageContext.request.contextPath }/delDevice.do" method="post">
                <div class="form-group has-success">
                    <label class="control-label" for="inputSuccess1">用户账号</label>
                    <input type="text" class="form-control" id="inputSuccess1" name="name" placeholder="请输入绑定账号">
                    <br><br>
                    <label class="control-label" for="inputSuccess2">填写正确的设备id号</label>
                    <input type="text" class="form-control" id="inputSuccess2" name="deviceId" placeholder="请输入设备id号">
                    <br><br>
                    <label class="control-label" for="inputSuccess3">填写设备名称</label>
                    <input type="text" class="form-control" id="inputSuccess3" name="deviceName" placeholder="请输入设备名称">
                    <br><br>
