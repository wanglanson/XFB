...
<div id="wrapper">
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="fankui.jsp">反馈信息</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" >
        ...
        <form action="${pageContext.request.contextPath }/addFeedback.do" method="post" enctype="multipart/form-data">
            <div id="page-inner">
                <div class="form-group">
                    <label>输入标题</label><br>
                    <input type="text" placeholder="请输入标题名" name="title" id="title">
                </div>
                <br>
                <div class="form-group">
                    <label>反馈内容</label>
                    <textarea class="form-control" rows="10" placeholder="请输入反馈内容" name="content" id="content"></textarea>
                </div>
                <br>
                ...
                <br>
                <div class="checkbox">
                    <button type="submit" class="btn btn-primary" id="sub">提交反馈</button>
                </div>
                <%
                    String title =request.getParameter("title");
                    String content =request.getParameter("content");
                    String fk1 = (String)request.getAttribute("fankui");//&&!title.equals("")&&!content.equals("")
                    if(fk1!=null){
                %>
