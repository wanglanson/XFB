...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="active-menu" href="announcement.do">通知信息</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper">
        ...
        <c:forEach items="${list1}" var="announcement" varStatus="st">
        <div class="row">
            <div class="col-md-12">
                <div class="jumbotron">
                    <h2>${announcement.title}</h2>
                    <p>发布内容：${announcement.content}</p><br>
                    <p style="float: right;">发布时间：${announcement.date}</p>
                </div>
            </div>
        </div>
        </c:forEach>
