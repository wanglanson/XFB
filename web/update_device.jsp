...
<div id="wrapper">
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="listDevice.do">我的设备</a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div id="page-wrapper">
        ...
        <div id="container">
            <label class="control-label" style="font-size: 28px;">当前已添加设备：</label><br><br>
            <c:forEach items="${list}" var="device" varStatus="st">
                <div class="alert alert-info">
                    <strong>设备名：</strong> ${device.deviceId}
                </div>
            </c:forEach>
        </div>
    </div>
